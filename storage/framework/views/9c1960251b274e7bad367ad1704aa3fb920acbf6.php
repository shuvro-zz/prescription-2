<?php $__env->startSection('page_title','Add Known Case'); ?>
<?php $__env->startSection('page_header','Add Known Case'); ?>
<?php $__env->startSection('page_breadcrumb'); ?>
    <ol class="breadcrumb">
        <li><a href="<?php echo e(url('home/dashboard')); ?>">Dashboard</a></li>
        <li><a href="<?php echo e(url('prescription/known_case')); ?>">Known case</a></li>
...
<?php $__env->startSection('page_content'); ?>    
    <div class="col-sm-12">
        <div class="white-box">
            <div class="row">
                <form action="<?php echo e(url('prescription/add_known_case_post')); ?>" method="post"><?php echo e(csrf_field()); ?>
