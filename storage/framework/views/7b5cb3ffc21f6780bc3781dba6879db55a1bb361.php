<?php $__env->startSection('page_title','Patient'); ?>
<?php $__env->startSection('page_header','Patient'); ?>
        ...
        <div class="white-box">
            ...
            <div class="table-responsive">
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>
                    <?php  $i=1;  ?>
                    <?php $__currentLoopData = $client_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr>
                            <td>
                                <?php echo e($i++); ?>

                            </td>
                            <td><a href="<?php echo e(url('patient/details/'.$row->id)); ?>"><?php echo e($row->name); ?></a></td>
                            ...
                            <td style="width: 10%; text-align: center;">
                                <a href="<?php echo e(url('patient/edit/'.$row->id)); ?>" data-toggle="tooltip"
