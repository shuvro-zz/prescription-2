...
<?php $__env->startSection('page_header','Edit Patient'); ?>
<?php $__env->startSection('page_breadcrumb'); ?>
    <ol class="breadcrumb">
        <li><a href="<?php echo e(url('home/dashboard')); ?>">Dashboard</a></li>
        <li><a href="<?php echo e(url('patient/show')); ?>">Patient</a></li>
...
<?php $__env->startSection('page_content'); ?>
    <div class="col-sm-12">
        <div class="white-box">
            <form data-toggle="validator" enctype="multipart/form-data" action="<?php echo e(url('patient/update')); ?>"
