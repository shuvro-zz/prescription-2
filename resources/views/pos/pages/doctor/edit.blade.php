...
@section('page_content')
    <div class="col-sm-12">
        <div class="white-box">
            <form data-toggle="validator" enctype="multipart/form-data" action="{{url('doctor/update')}}"
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea name="degree" id="degree" rows="5" class="form-control">{{$all_info[0]['degree']}}</textarea>
                    </div>
                </div>
