    ...
    <div class="navbar-header">
        ...
        <div class="top-left-part">
            <a class="logo" href="{{url('home/dashboard')}}">
                <b>
                    <img style="height: 60px; width:60px;" src="{{url('public/images/')}}/<?=$company_info[0]->logo;?>" alt="Logo"/>
                </b>
                <span class="hidden-xs">
                   <?=$company_info[0]->title;?>
                    {{--<img src="{{url('resources/assets/pos/')}}/images/eliteadmin-text.png" alt="home"/>--}}
                </span>
            </a>
        </div>
        <ul class="nav navbar-top-links navbar-right pull-right">
            <li class="dropdown"><a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <i
                            class="fa fa-user"></i>&nbsp<b class="hidden-xs"> {{$reg_info[0]->reg->name}}</b> </a>
                <ul class="dropdown-menu dropdown-user scale-up">
                    ...
                    <li role="separator" class="divider"></li>
                    <li><a href="{{url('auth/logout')}}"></i>Log-out</a></li>
                </ul>
            </li>
        </ul>
    </div>
            ...
            <div class="modal-body">
                <div>
                    <table class="table table-bordered ">
                        <tr>
                            <td>Name</td>
                            <td>{{$reg_info[0]->reg->name}}</td>
                        </tr>
                        <tr>
                            <td>Designation</td>
                            <td>{{$reg_info[0]->reg->designation}}</td>
                        </tr>
                        <tr>
                            <td>Phone</td>
                            <td>{{$reg_info[0]->reg->phone}}</td>
                        </tr>
                    </table>
                </div>
            </div>
...
<div class="modal fade" id="myModal_edit" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form data-toggle="validator" action="{{url('home/update_profile_info')}}" method="post">
                {{csrf_field()}}
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-12 col-md-offset-0">
                            ...
                            <div class="col-md-9">
                                <input name="name" value="{{$reg_info[0]->reg->name}}" type="text"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group col-md-12 col-md-offset-0">
                            ...
                            <div class="col-md-9">
                                <input name="phone" value="{{$reg_info[0]->reg->phone}}" type="text"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="edit_id" value="{{$reg_info[0]['id']}}">
...
<div class="modal fade" id="myModal_pass" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form data-toggle="validator" action="{{url('home/update_password')}}" method="post">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="form-group col-md-12 col-md-offset-0">
                    ...
                    <input type="hidden" name="old_pass" value="{{$reg_info[0]->password}}">
                    <input type="hidden" name="reg_id" value="{{$reg_info[0]->reg_id}}">
                    <div class=" form-group" style="text-align: center;">
                        <button type="submit" class="btn btn-success">Submit</button>
                    </div>
                </form>
