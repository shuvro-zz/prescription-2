<head>
    ...
    <!--datatable-->
    <link href="{{url('resources/assets/pos/')}}/bower_components/datatables/jquery.dataTables.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <!-- Page plugins css -->
    <link href="{{url('resources/assets/pos/')}}/bower_components/clockpicker/dist/jquery-clockpicker.min.css"
          rel="stylesheet">
    <!-- Color picker plugins css -->
    <link href="{{url('resources/assets/pos/')}}/bower_components/jquery-asColorPicker-master/css/asColorPicker.css"
          rel="stylesheet">
    ...
    <link href="{{url('resources/assets/pos/')}}/bower_components/timepicker/bootstrap-timepicker.min.css"
          rel="stylesheet">
    <link href="{{url('resources/assets/pos/')}}/bower_components/bootstrap-daterangepicker/daterangepicker.css"
          rel="stylesheet">
